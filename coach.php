...
<a class="navbar-brand" href=""><img src = 'BodyTone.png' alt="your image" width="60" height="60"> </a>
  ...
  <ul class="navbar-nav">
      <li class="nav-item">
        <a class="nav-link" href="coach.php">Coach Register</a>
      </li>
...
<!-- nav close -->
<h3 style="color: white;">Register now to become a coach with us...</h3>
<br>
<br>
<!-- nav close -->
...
<form>
  ...
  <div class="form-group">
    ...
    <input type="text" name = "period" class="form-control" id="inputAddress" placeholder="DOB">
  </div>
  <div class="form-group">
